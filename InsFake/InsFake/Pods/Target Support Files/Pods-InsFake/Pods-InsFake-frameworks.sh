...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GXWaterCollectionViewLayout/GXWaterCollectionViewLayout.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HDAlertView/HDAlertView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LemonBubble/LemonBubble.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WSDatePickerView/WSDatePickerView.framework"
